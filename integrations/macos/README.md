# TypeTune macOS local preview

Apple Silicon, macOS 27.0, ABC ↔ Russian — PC. Native SwiftUI/AppKit shell,
one serial controller/runtime, Rust `typetune-bridge` protocol 2 in the app bundle.
No Python/GTK runtime. No Espanso code copied.
