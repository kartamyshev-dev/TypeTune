...
class Checks(unittest.TestCase):
    ...
    def test_mutation_is_followed_by_effective_state(self):
        ...
        current, error = request('pause', runner=runner)
    ...
    def test_invalid_status_and_commands_do_not_fake_success(self):
        ...
        with self.assertRaises(ValueError): request('status', runner=runner)
        with self.assertRaises(ValueError): request('uninstall', runner=runner)
        with self.assertRaises(ValueError): request('mode-ibus', runner=runner)
