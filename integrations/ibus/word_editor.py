...
class WordEditor(Gtk.Window):
    def __init__(self, parent, requester=exchange):
        ...
        box.append(Gtk.Label(label='По одному слову на строку, 2–32 буквы. До 500 слов в каждом списке. Регистр не учитывается; исключения имеют приоритет.',wrap=True,xalign=0))
