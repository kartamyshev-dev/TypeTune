...
automatic = True
shared.AUTOMATIC = lambda: automatic
...
def status():
    return dict(automatic=automatic, mode=guard.source_id, mode_result=guard.mode_result, enabled=guard.enabled, available=guard.allows(), reason=guard.reason,
