...
proposals=[dict(id='one',source='ghbdtn',word='привет',count=3,backend='compatibility'),dict(id='two',source='nbgn.y',word='типтюн',kind='word',count=3,backend='compatibility')]
resolved=[]
