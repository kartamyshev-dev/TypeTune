...
mod manual;
pub use automatic::{
    lexicon_entry_counts, prepare_automatic, prepare_automatic_with_dictionary,
    prepare_automatic_with_policy, prepare_toggle, AutoAction, AutoPolicy, LexiconCounts,
};
