...
impl ContextSnapshot {
    ...
    pub fn replacement_blockers(
        ...
        // `checked_duration_since` is `None` for a future capture time, which
        // counts as stale exactly like an over-age context.
        let stale = match now.checked_duration_since(self.captured_at) {
