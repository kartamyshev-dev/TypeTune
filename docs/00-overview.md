...
Дополнение 2026-09-18: [локальный macOS preview](57-macos-checkpoint.md)
собран и установлен на Apple Silicon/macOS 27.0. Общесистемная коррекция ещё
не принята: ожидаются системные разрешения и native cases. Linux остаётся
отдельной платформой со своим статусом ниже.
