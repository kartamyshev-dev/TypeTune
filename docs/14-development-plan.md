...
## Актуальная точка продолжения — 2026-09-17

Linux baseline — этапы 53–55: единый compatibility runtime, без IBus,
предложения словаря и пробел до/после Double Shift. Проверки: 120 Rust и
68 Python tests, GTK fixtures, отдельные native Wayland/XWayland стенды;
...
Их исторические формулировки не заменяют текущие checkpoints и не подтверждают
готовность функций по наличию исходников. Для G5/G6 приоритет имеет план 56.
