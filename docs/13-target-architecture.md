...
Статус: проектное решение для следующего этапа; **ещё не реализовано**. Основание: аудит ревизии `8cc19d0` от 2026-09-10. Этот документ заменяет прежнюю архитектуру единого `evdev → Vec<InputEvent> → uinput` для всех функций.
