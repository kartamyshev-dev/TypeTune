...
Статус: **запланирован, не реализован**. Добавлен 2026-09-16 после пользовательской
проверки: ручное переключение работает, но многие слова не исправляются автоматически.
Текущий matcher использует лишь 150 русских и 149 английских слов, длину 4–32
